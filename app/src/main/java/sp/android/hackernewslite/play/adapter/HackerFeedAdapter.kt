package sp.android.hackernewslite.play.adapter
...
import sp.android.hackernewslite.play.extensions.relativeDateFormat
...
class HackerFeedAdapter : RecyclerView.Adapter<HackerFeedAdapter.ArticleViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HackerFeedAdapter.ArticleViewHolder {
    ...
    override fun onBindViewHolder(holder: HackerFeedAdapter.ArticleViewHolder, position: Int) {
