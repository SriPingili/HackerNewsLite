...
fun Date?.relativeDateFormat(context: Context, now: Date = Date()): String? {
    ...
    val timeDateFormat = SimpleDateFormat(context.getString(R.string.time_only_date_format), defaultLocale)
    val dayOfWeekDateFormat = SimpleDateFormat(context.getString(R.string.day_of_week_date_format), defaultLocale)
    val shortFormDateFormat = SimpleDateFormat(context.getString(R.string.short_form_date_format), defaultLocale)
    val longFormDateFormat = SimpleDateFormat(context.getString(R.string.long_form_date_format), defaultLocale)
